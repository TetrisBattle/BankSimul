...
QT_MOC_LITERAL(1, 5, 10), // "rfidSignal"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "rfidSlot"
QT_MOC_LITERAL(4, 26, 12) // "kortinNumero"

    },
    "RFID\0rfidSignal\0\0rfidSlot\0kortinNumero"
};
...
void RFID::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rfidSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->rfidSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RFID::rfidSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RFID::rfidSignal(QString _t1)
{
